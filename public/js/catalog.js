...
//     console.log(newList);
//     return (newList.length === 0 || newList[0].length === 3) ? ["Not Available"] : newList;
// };
//
...
//             url: 'api/courses',
//             data: {
//                 urlExtension: searchQuery
//             }
//         });
//         $('.all_courses').html(`<h1 style="position: fixed; font-color: white; left:30%; top: 50%; translate:(-30%,-50%); font-size: 6vw">SEARCHING...</h1>`);
//         $.ajax({
...
//
//             courseInfos = courseInfos.sort((a,b) => {
